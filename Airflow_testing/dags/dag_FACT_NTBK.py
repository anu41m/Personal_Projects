...
@dag(start_date=datetime(2021,1,1), schedule_interval="35 15 * * *", catchup=False, default_args=default_args)
...
def dag_Fact_NTBK():
    ...
    NB_Notebook_job=DockerOperator(
        ...
        command= 'papermill /home/jovyan/Notebooks/NB_FACT_NTBK.ipynb /home/jovyan/Notebooks/output/NB_FACT_NTBK.ipynb --log-output',
