...
def dag_NB_Fetch_Google_Finance():
    ...
    NB_Notebook_job=DockerOperator(
        ...
        command= 'papermill /home/jovyan/Notebooks/NB_Fetch_Google_Finance.ipynb /home/jovyan/Notebooks/output/NB_Fetch_Google_Finance.ipynb --log-output',
...
dag = dag_NB_Fetch_Google_Finance()